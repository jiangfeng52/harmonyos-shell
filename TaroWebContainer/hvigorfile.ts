        ...
        apply(pluginContext) {
            pluginContext.registerTask({
                ...
                run: (taskContext) => {
                    ...
                    let injectFilePath = path.join(taskContext.modulePath, "src", "main", "resources", "rawfile", "inject.js")
                    ...
                    let outputFilePath = path.join(taskContext.modulePath, "src", "main", "resources", "rawfile", "injectTransform.js")
