// @ts-ignore
const http = requireNapi('net.http')
// @ts-ignore
const display = requireNapi('display')
// @ts-ignore
const wifiManager = requireNapi('wifi')
// @ts-ignore
const call = requireNapi('telephony.call')
// @ts-ignore
const bluetooth = requireNapi('bluetooth')
// @ts-ignore
const inputMethod = requireNapi('inputMethod')
// @ts-ignore
...
try {
  ...
  console.error('get bundleInfoFor fail:' + JSON.stringify(e))
}
